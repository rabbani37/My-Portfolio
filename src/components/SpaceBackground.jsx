...
function SpaceBackground() {
  // useState(() => ...) — এখানে function pass করা হচ্ছে, generateStars(120) সরাসরি call করা হচ্ছে না।
  // এটাকে বলে "lazy initial state" — React docs এ officially recommended pattern।
  // React শুধু component প্রথমবার mount হওয়ার সময় এই function টা একবার চালাবে,
  // তারপর re-render হলে আর কখনো চালাবে না (state ভ্যালু already সেভ হয়ে গেছে বলে)।
